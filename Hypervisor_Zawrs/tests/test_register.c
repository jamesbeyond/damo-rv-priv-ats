 ...
 * DOCS/testplan/Hypervisor_Zi_test_plan.md Group 4.
 *
 ...
 *
 * Execution order:
 *   Group 4.1 (normal execution): HZWRS-01~03  HS/VS/VU wrs normal
 *   Group 4.2 (VTW gating):       HZWRS-04~07  VTW virtual-instruction
 *   Group 4.3 (TW priority):      HZWRS-08~12  TW over VTW, scope
 */
